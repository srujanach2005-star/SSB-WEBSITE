function initTestimonialCarousel() {
  const track = document.getElementById('testimonial1Track');
  const prevBtn = document.getElementById('testimonial1Prev');
  const nextBtn = document.getElementById('testimonial1Next');
